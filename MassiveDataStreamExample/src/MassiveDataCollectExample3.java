...
public class MassiveDataCollectExample3 {
	...
	public static void testCsvStreamSqlArrivalDelayCarrierRightOuterJoinCodeFiltered() throws Throwable {
		...
		map.mapTuple((Tuple tup)->Tuple.tuple(((Tuple2)tup).v1, new Long((String)((Tuple2)tup).v2))).reduceByKey((a,b)->(Long)a+ (Long)b,null).groupByKey()
