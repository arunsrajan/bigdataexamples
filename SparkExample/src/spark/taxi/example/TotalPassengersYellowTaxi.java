...
public class TotalPassengersYellowTaxi {
	...
	public static void main(String[] args) {
		...
		Dataset<Row> totalpassengers = taxiyellow.map(dat->Long.parseLong(dat.getAs("passenger_count")), Encoders.LONG()).groupBy().sum();
