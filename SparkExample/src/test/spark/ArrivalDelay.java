...
public class ArrivalDelay {
	...
	public static void main(String[] args) {
		...
		JavaPairRDD<String, Long> carrierarrvdelay = filterdataarrdelay.mapToPair(line -> new Tuple2<String,Long>(line[8], Long.parseLong(line[14]))).coalesce(1).reduceByKey((a,b)->a+b);
		...
		JavaPairRDD<String, Long> numofrecordsarrvdelay = filterdataarrdelay
				.mapToPair(line -> new Tuple2<String,Long>(line[8], 1l)).coalesce(1).reduceByKey((a,b)->a+b);
		...
		combinearrvdelaynumrecords.saveAsTextFile("hdfs://127.0.0.1:9000/airlinecarriers/arrdelay" + System.currentTimeMillis());
	}
